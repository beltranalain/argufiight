  ...
  const tabs = [
      ...
      content: (
        <div className="space-y-8">
          ...
          {stats && stats.usageByProvider.length > 0 && (
            <Card>
              <CardHeader>
                <h2 className="text-xl font-bold text-white">Usage by Provider</h2>
              </CardHeader>
              <CardBody>
                  ...
                  {stats.usageByProvider.map((provider) => (
                    ...
                    >
                      <div className="flex items-center justify-between mb-4">
                        <h3 className="text-lg font-semibold text-white capitalize">{provider.provider}</h3>
    ...
    },
    {
      ...
      content: (
        <Card>
          <CardHeader>
            <h2 className="text-xl font-bold text-white">API Usage Records</h2>
          </CardHeader>
          <CardBody>
            {records.length === 0 ? (
              <EmptyState
  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="text-4xl font-bold text-white mb-2">API Usage & Costs</h1>
