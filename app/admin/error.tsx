  ...
  return (
    <div className="min-h-[60vh] flex items-center justify-center p-4">
      <div className="max-w-md w-full text-center">
        ...
        <h2 className="text-2xl font-bold text-text-primary mb-2">Admin Panel Error</h2>
        <p className="text-text-secondary mb-6">
          Something went wrong in the admin panel. Please try again or contact the development team.
        </p>
